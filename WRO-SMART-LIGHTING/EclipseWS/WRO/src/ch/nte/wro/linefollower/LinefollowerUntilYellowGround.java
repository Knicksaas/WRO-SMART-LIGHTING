...
public class LinefollowerUntilYellowGround {
	...
	public LinefollowerUntilYellowGround(int speed, RegulatedMotor mLeft, RegulatedMotor mRight, int kp) {
		this.kp = kp;
		this.speed = speed;
		this.mLeft = mLeft;
		this.mRight = mRight;
	...
	private void followLine() {
		...
		while(running) {
			...
			if((lLeft.getIntensity() + lRight.getIntensity()) > 0.7) {
